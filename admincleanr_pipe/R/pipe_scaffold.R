...
#'   \item See \code{admincleanr_training()} after \code{library(admincleanr)} for the planned split between \pkg{admincleanr_crunch} heuristics and pipe-stable code.
#' }
#'
