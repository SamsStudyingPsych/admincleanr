...
#' Once formats are understood, encode them explicitly
#' (see [lubridate::parse_date_time()] / SQL casting in production pipelines).
#'
#' @section Limitations:
#' \itemize{
...
#'   \item See \code{\link{admincleanr_training}} for extract-to-report sequencing.
#' }
#'
