...
#' together SQL handoff, cleaning helpers, and linkage heuristics. Keep it open while
#' you sketch an analysis script so function choices stay consistent with the
#' documented pipeline.
#'
